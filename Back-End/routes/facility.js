...
router.post("/new-facility", (req, res) => {
    ...
    const { name ,images , location, description , city , price ,type , appointment} = req.body;

    Facility.create({ name : name ,images : images , location :location ,description : description
    , city : city , price : price , type : type , appointment: appointment}, (err, newFacility) => {
...
router.get("/facilities/:id", (res,req)=>{
